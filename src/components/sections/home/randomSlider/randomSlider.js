...
const RandomSlider = (props) => {
  return (
    <div className="card">
      <Link
        to={`/view/${props.randomItems.parent_id}/${props.randomItems.slug}`}
        className="card__cover"
      >
        <img src={tubeServer + props.randomItems.poster_img} alt={props.randomItems.slug} />
...
export default connect(mapStateToProps, null)(RandomSlider);
